 ...
 *                  Las imágenes se representan como matrices de enteros sin signo de 16 bits.
...
int main() {
     ...
     */  
    for (uint32_t i = 0; i < N*N; i+= 2) {
        asm volatile (
            "lw t1, 0(%0)\n\t"       // Cargar los valores de 16 bits de data1[i:i+1] en t1
            "lw t2, 0(%1)\n\t"       // Cargar los valores de 16 bits de data2[i:i+1] en t2
            "sltu16 t3, t2, t1\n\t"  // t3 almacena 0xffff en los valores de 16 bits que t1 es mayor que t2
            "sltu16 t4, t1, t2\n\t"  // t4 almacena 0xffff en los valores de 16 bits que t2 es mayor que t1
            "and t5, t1, t3\n\t"     // t5 almacena los valores de 16 bits de t1 que son mayores que t2
            "and t6, t2, t4\n\t"     // t6 almacena los valores de 16 bits de t2 que son mayores que t1
            "or t5, t6, t5\n\t"      // t5 almacena los valores de 16 bits mas grándes entre t1 y t2
            "and t4, t1, t4\n\t"     // t3 almacena los valores de 16 bits de t1 que son menores que t2
            "and t3, t2, t3\n\t"     // t4 almacena los valores de 16 bits de t2 que son menores que t1
            "or t6, t4, t3\n\t"      // t6 almacena los valores de 16 bits mas pequeños entre t1 y t2
            "sub16 t1, t5, t6\n\t"   // t1 almacena la diferencia entre los valores de 16 bits de t1 y t2
            "sw t1, 0(%2);"          // Escribe t1 en resul_simd[i:i+1]
